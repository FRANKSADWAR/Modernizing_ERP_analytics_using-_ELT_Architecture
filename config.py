...
TABLE_LIST = ['Customer','Sales Team','Supplier','Contact','Address','Employee',
              'Sales Order','Sales Invoice','Delivery Note','Credit Limit','Purchase Order',
              'Purchase Invoice','Purchase Receipt','Journal Entry','Journal Entry Reference','GL Entry','Account',
