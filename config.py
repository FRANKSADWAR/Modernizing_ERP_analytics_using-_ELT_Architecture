...
TABLE_LIST = ['Customer','Sales Team','Supplier','Contact','Address','Employee',
              'Sales Order','Sales Invoice','Delivery Note','Customer Credit Limit','Purchase Order',
              'Purchase Invoice','Purchase Receipt','Journal Entry','Journal Entry Account','GL Entry','Account',
